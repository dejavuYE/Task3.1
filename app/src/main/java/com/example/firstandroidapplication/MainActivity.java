...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putInt("microflora", count); // запечатывание данных в контейнер Bundle outState под ключом microflora
        outState.putInt("microfloraPre", preCount); // запечатывание данных в контейнер Bundle outState под ключом microfloraPre
    }
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        count = savedInstanceState.getInt("microflora"); // извлечение данных из контейнера Bundle savedInstanceState по ключу microflora
        preCount = savedInstanceState.getInt("microfloraPre"); // извлечение данных из контейнера Bundle savedInstanceState по ключу microfloraPre
        output.setText("" + count); // вывод на экран извлечённых данных
    }
